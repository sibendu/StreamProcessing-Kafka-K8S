...
public class FrequentTxnProcessor {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String bootstrapServers = args.length > 0 ? args[0] : "localhost:9092";//"129.213.158.157:9092";
        ...
        final KStream<String, String> anomalousUsersForConsole = anomalousUsers
          ...
          .map((userId, count) -> new KeyValue<>(userId.toString(), count + " transactions within 1 minute"));
        
        //System.out.println("4");windowedUserId
